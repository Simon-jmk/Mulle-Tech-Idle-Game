...
const ButtonSVG = ({ isPressed, style }: { isPressed: boolean, style?: React.CSSProperties }) => {
  const topY = isPressed ? 69.8 : 43.92;
  const rectHeight = isPressed ? 8.624 : 34.505;
  const rectY = isPressed ? 69.8 : 43.92;
  ...
  return (
    ...
    >
      <g id="Layer1">
        <g>
          <ellipse cx="84" cy="92.676" rx="84" ry="44.924" style={{ fill: 'var(--button-rim-color)' }} />
          <rect x="0" y="80.62" width="168" height="12.056" style={{ fill: 'var(--button-rim-color)' }} />
          <ellipse cx="84" cy="80.62" rx="84" ry="44.924" style={{ fill: 'var(--button-rim-light)' }} />
        </g>
        <g>
          <ellipse cx="84" cy="78.424" rx="79.894" ry="42.728" style={{ ...transitionStyle, fill: 'var(--button-shade-color)' }} />
